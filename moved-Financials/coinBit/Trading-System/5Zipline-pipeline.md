...
- [pipeline example](https://github.com/quantopian/zipline/blob/master/zipline/examples/momentum_pipeline.py) - works with Zipline. 
- Study above example and run int Virtual env, compare this with Quantopian Pipeline and see the difference ..
- If zipline works well with Pipeline, we prefer it than Quantopian as we can customize more with zipline ..
```
"""
