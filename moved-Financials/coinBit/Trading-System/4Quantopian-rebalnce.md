...
#### This is a [template algorithm on Quantopian](https://www.quantopian.com/algorithms/5820f60d644711343c0001dc) for you to adapt and fill in.
-  There is no hanle_data() funciton in this code because, schdule_funciton() is used , it calls relance() and record_vars() for the specified days and Time
```
"""
